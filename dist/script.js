...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.setAttr = function (attributeName, attributeValue) {
  for (let i = 0; i < this.length; i++) {
...
const a = Object(_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])('.active').on('click', function () {
  Object(_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])(this).setAttr("data-url", "disabled");
});
